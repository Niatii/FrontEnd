...
<body class="bg-latar text-black min-h-screen">
    ...
    <section class="pt-36 sm:pt-40 mb-12 mx-8">
        <div class="bg-white w-full rounded-md">
            <div class="mx-3 my-2">
                <h1 class="pt-6 font-bold text-wjudul my-4 md:text-2xl lg:text-3xl md:my-6 sm:mx-6" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="200" data-aos-offset="0">Publikasi</h1>
            </div>
