...
<body class="bg-latar">
    ...
    <section class="pt-36 sm:pt-40 mb-12 mx-8 flex justify-center">
        <div class="container bg-white pl-4 pb-8 lg:pl-7 rounded-md">
            <p class="py-4 sm:text-lg lg:text-2xl sm:py-6">Title Page</p>
            <div class="flex w-max-full mb-5 sm:mb-9">
                <div>
                    <img src="{{ asset('storage/properti/2.jpg') }}" alt=""
                    class="w-32 sm:w-72">
                </div>
                <div class="w-1/2 sm:w-8/12 lg:mx-16 lg:py-6 mx-8">
                    ...
                    <a href="#" class="text-[9px] md:text-[10px] hover:text-sky-600">Selengkapnya...</a>
                </div>
            </div>
            <div class="flex w-max-full mb-5 sm:mb-9">
                <div>
