        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="w-full md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-4 space-y-4 md:space-y-5 sm:p-8 text-white ">
                    ...
                    <form class="space-y-2 md:space-y-4" action="{{ route('register') }}" method="POST">
                        @csrf
                        <div>
                        ...
                        <div class="flex gap-2 w-full">
                            <div>
                                <label for="namapengguna" class="block mb-2 text-xs  text-white">Nama Pengguna</label>
                        ...
                        <div class="text-center mt-4 lg:text-xs lg:mt-5">
                            <button type="submit" class="bg-gradb text-[10px] w-10/12 rounded-2xl py-2 text-white lg:text-xs mt-4 lg:py-3 lg:rounded-3xl hover:bg-nav transition duration-700 ">Daftar</button>
                        </div>
