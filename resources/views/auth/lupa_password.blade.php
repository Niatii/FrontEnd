              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  <div>
                    ...
                    <div class="text-center mt-4 lg:text-xs lg:mt-5">
                        <a href="/verifikasi" type="submit" class="bg-gradb text-[10px] w-8/12 rounded-2xl py-2 text-white lg:text-xs
                        lg:py-3 lg:rounded-3xl hover:bg-nav transition duration-700 my-6 ">Kirim Kode</a>
                    </div>
