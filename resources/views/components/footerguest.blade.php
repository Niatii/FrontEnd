    ...
    <div class="container max-w-full pt-2">
      <div class="grid grid-cols-3 gap-x-3 ">
          <div class="border-r-2 border-black px-5 justify-items-center grid ">
            <div class="grid">
              <h1 class="py-5 w-full font-bold text-xs sm:text-lg lg:text-2xl">Layanan</h1>
          ...
          <div class="border-r-2 border-black px-4 justify-items-center grid">
            <div>
              <h1 class="py-5 w-full font-bold text-xs sm:text-lg lg:text-2xl">Hubungi Kami</h1>
                <p class="text-xs py-1 sm:text-base">No telp 08-xx-xx</p>
                <p class="text-xs sm:text-base">
                  Jl. Ahmad Yani, Tlk. 
                  <br>Tering, Kec. Batam <br>
                  Kota, Kota Batam, <br>
          ...
          <div class="px-2">
            <div class="flex justify-end mx-5 my-5">
              <img src="{{ asset('storage/properti/logo.png') }}" alt="" class="min-w-12 w-1/3 ml-5 mb-12">
            </div>
            <div class="flex justify-end gap-1 lg:gap-4">
              <a href="https://www.facebook.com/NASA?mibextid=ZbWKwL"><i class="fab fa-facebook text-xl lg:text-3xl"></i></a>
              <a href="https://www.instagram.com/nasa?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><i class="fab fa-instagram text-xl lg:text-3xl"></i></a>
              <a href="https://x.com/NASA?s=20"><i class="fab fa-twitter text-xl lg:text-3xl"></i></a>
