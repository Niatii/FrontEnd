            ...
            <div class="px-5 pt-20 md:px-20 w-full ">
                <div class="flex flex-col justify-between py-4 leading-normal">
                    <form method="POST" action=" {{route('admin.tentangkami.tambah')}}" enctype="multipart/form-data">
                        @csrf
                        <div>
                            <input class="block w-full mb-5 text-xs text-gray-900 border border-black 
                        ...
                        <div class="border border-black my-5 rounded-lg">
                            <textarea id="informasi" name="content" rows="15" class="block w-full  
                            text-sm border-none focus:ring-primary-500 focus:border-primary-500 overflow-y-scroll" 
                            placeholder="Tambah Informasi..."></textarea>
                        </div>

                        <div class="flex justify-end">
                            <button href="/admin/tentangkami" type="submit" class="bg-nav hover:bg-gradb
                             text-xs md:text-base text-white py-2 px-4 md:px-8
                                rounded-md">
                                Tambah
                            </button>
                        </div>
