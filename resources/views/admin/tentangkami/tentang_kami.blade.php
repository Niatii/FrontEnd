...
<body class="bg-latar text-black min-h-screen">
    ...
    <div class="fixed right-0 bottom-16 z-10">
        <a href="{{route('admin.tentangkami.tambah')}}" class="bg-nav hover:bg-gradb text-xs md:text-base text-white py-2 px-4 md:px-8
    ...
    <section class="pt-36 mx-8 sm:pt-40">
        @if (session('success'))
        <div class="bg-white text-blue-900 p-4 rounded mb-8" style=" margin-bottom: 1rem;">
            {{ session('success') }}
        </div>
        @endif
