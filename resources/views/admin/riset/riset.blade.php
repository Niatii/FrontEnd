...
<body class="bg-latar text-black pb-12 min-h-screen">
   ...
   @include('components.headeradmin')
    ...
    <div class="fixed right-0 bottom-28 z-10">
        <a href="{{route('admin.riset.tambah')}}" class="bg-nav hover:bg-gradb text-xs md:text-base text-white py-2 px-4 md:px-8
        ...
        <div class="bg-white w-full rounded-md pb-40">
            ...
            @foreach ($files as $file)
                ...
                data-aos-anchor-placement="center-bottom">
                    <a href="{{ route('admin.riset.detail', $file->riset_id) }}">
                    ...
                    <div class="py-3">
                        ...
                        <p class="mb-3 text-[10px] overflow-hidden md:text-xs h-[62px]">{{ $file->content }}</p>
                    </div>
                </div>
